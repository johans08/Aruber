...
<figure class="highcharts-figure">
    ...
    <p class="highcharts-description">
        En esta grafica se van a mostrar los ingresos por año
    </p>
</figure>
...
Highcharts.chart('container', {
    ...
    subtitle: {
        text: 'Ingresos que se han ganado por viaje'
    },
    xAxis: {
        data:[
            <?php
            ...
            {
            ?>
            ['<?php echo $registros["fechaFactura"]; ?>'],
        ...
        accessibility: {
            rangeDescription: 'Ganancias ganadas al año'
        },
        maxPadding: 0.05,
        showLastLabel: true
    },
    ...
    series: [{
        ...
        data: [
            ...
            {
            ?>
            ['<?php echo $registros["monto"]; ?>', <?php echo $registros["fechaFactura"] ?>],
