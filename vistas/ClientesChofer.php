...
<figure class="highcharts-figure">
    ...
    <p class="highcharts-description">
        En esta grafica se mostraran la cantidad de viajes de los diferentes usuarios.
    </p>
</figure>
...
Highcharts.chart('container', {
    ...
    series: [{
        name: 'CANTIDAD DE VIAJES POR USUARIO: ',
        colorByPoint: true,
        data: [
            <?php
            ...
            {
            ?>
            ['<?php echo $registros["usuario"]; ?>', Math.floor(Math.random() * 101)],
