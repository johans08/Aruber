                        ...
                        <div class="row">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">MANTENIMIENTO CHOFERES!</h1>
                                </div>
                            ...
                            <br>
                            <h3>Tabla con informacion de choferes</h3>


                            <br><br>
                            <div class="row">
                                <div class="col-md-12">
                                    <table id="dt_choferes"  class="table  table-hover dt-responsive nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Id Chofer</th>
