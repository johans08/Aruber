...
<html lang="en">
    ...
    <head>
        ...
        <title>PANTALLA ADMINISTRADORES ADMIN</title>
        ...
        <script type="text/javascript" src="backend/js/administradoresFunctions.js"></script>
                            ...
                            <div class="col-lg-7">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">PAGINA PARA ADMINISTRADORES!</h1>
                                    </div>
                                    <form class="user" role="form" onsubmit="return false;" id="formadministradores" action="backend/controller/administradoresController.php">
                                        <div class="form-group row">
                                            <div class="form-group" id="groupidAdministradors">
                                                <input type="text" class="form-control form-control-user" id="txtidAdministrador"  placeholder="Id Administrador">
                                            </div>
                                            <div class="form-group" id="groupnombreAdmin">
                                                <input type="text" class="form-control form-control-user" id="txtnombreAdmin"  placeholder="Nombre administrador">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="form-group" id="groupapellido1Admin">
                                                <input type="text" class="form-control form-control-user" id="txtapellido1Admin"  placeholder="Primer Apellido administrador">
                                            </div>
                                            <div class="form-group" id="groupapellido2Admin">
                                                <input type="text" class="form-control form-control-user" id="txtapellido2Admin"  placeholder="Segundo Apellido administrador">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="form-group" id="groupcorreoAdmin">
                                                <input type="text" class="form-control form-control-user" id="txtcorreoAdmin"  placeholder="Correo">
                                            </div>
                                            <div class="form-group" id="groupusuario">
                                                <input type="text" class="form-control form-control-user" id="txtusuarioAdmin"  placeholder="usuario">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="form-group" id="groupcontrasenaAdmin">
                                                <input type="password" class="form-control form-control-user" id="txtcontrasenaAdmin"  placeholder="contrasenaAdmin">
                                            </div>
                                            <div class="form-group" id="grouptipoUsuario">
                                                <input type="text" class="form-control form-control-user" id="txttipoUsuario"  placeholder="tipoUsuario">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="form-group" id="groupActivo">
                                                <input type="text" class="form-control form-control-user" id="txtActivo"  placeholder="Estado del administrador">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <input type="hidden" id="typeAction" value="add_administradores" />
                                ...
                                <br>
                                <h3>Tabla con informacion de administradores</h3>


                                <br><br>
                                <div class="row">
                                    <div class="col-md-12">
                                        <table id="dt_administradores"  class="table  table-hover dt-responsive nowrap" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Contraseña del administrador</th>
                                                    <th>Tipo de usuario del administrador</th>
                                                    <th>Estado del administrador</th>
                                                    <th>Acciones</th>
                                                </tr>
                                            </thead>
                                        </table>
